...
sed -i.bak "s/v_ident_better\.mp3/v_ident_better.mp3\?v=$(shasum ./dist/clips/v_ident_better.mp3 | cut -c 1-10)/" ./dist/main.js
sed -i.bak "s/h_ident_better\.mp3/h_ident_better.mp3\?v=$(shasum ./dist/clips/h_ident_better.mp3 | cut -c 1-10)/" ./dist/main.js
